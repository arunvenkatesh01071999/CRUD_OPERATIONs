...
app.post('/details',(request,response)=>{
    ...
    const sql='insert into studentdb.studentdetails(fname,lname,dob,email,education,location,about) values (?,?,?,?,?,?,?)';
...
app.delete('/delet/:id',(request,response)=>{
    ...
    let sql = 'DELETE from studentdb.studentdetails where id=?';
...
app.put('/updat',(request,response)=>{
    ...
    const id=request.body.usid;
        ...
        let sql = `update studentdb.studentdetails set fname=?,lname=?,dob=?,email=?,education=?,location=?,about=? where id=${id}`;
    ...
    app.get('/editview/:usd',(request,response)=>{     
        ...
        let sql=`select * from studentdb.studentdetails where id=${id}`
